...
String[] modes = {"Moving", "Bounce", "Gravitational Orbit", "Spring", "Drag", "Electric", "Ordered Orbs"};
...
void draw() {
  ...
  if (toggles[MOVING]) {
    ...
    if (comboSim) {
      toggles[GRAVITY] = toggles[SPRING] = toggles[ELECTRIC] = true;
    }
...
void writeControls() {
  textSize(15);
  text("Press-->SPACE:moving, b:bounce, 1:Gravitational sim, 2:Spring sim, 3:Drag sim, 4:Electricity sim, 5:Combo sim, 6:Random Orbs", 0, height - 30);
